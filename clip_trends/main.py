# clip_trends/main.py
"""CLI 入口: python -m clip_trends.main --once  |  python -m clip_trends.main --daemon"""
import sys
...
def main():
    ...
    if '--once' in sys.argv:
        ...
        print("用法: python -m clip_trends.main --once    (手动执行一次)")
        print("      python -m clip_trends.main --daemon  (启动定时守护进程)")
